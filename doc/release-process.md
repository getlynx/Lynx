...
* Update the anchor nodes (`ANCHOR_NODES` table) in [`src/kernel/chainparams.cpp`](/src/kernel/chainparams.cpp) if any anchor VPS has been added, removed, or re-addressed.
