    ...
    m_network_style(networkStyle)
{
    ...
    labelStakingIcon = new GUIUtil::ThemedLabel(platformStyle);
...
void BitcoinGUI::updateHeadersSyncProgressLabel()
{
    ...
    int estHeadersLeft = (GetTime() - headersTipTime) / Params().GetConsensus().GetPowTargetSpacing(headersTipHeight);
...
{
    int estHeadersLeft = blockDate.secsTo(QDateTime::currentDateTime()) / Params().GetConsensus().GetPowTargetSpacing(height);
    if (estHeadersLeft > HEADER_HEIGHT_DELTA_SYNC)
