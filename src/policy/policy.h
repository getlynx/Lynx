...
static constexpr unsigned int MAX_STANDARD_TX_WEIGHT{800000};
...
static constexpr unsigned int DEFAULT_ANCESTOR_LIMIT{36};
/** Default for -limitancestorsize, maximum kilobytes of tx + all in-mempool ancestors */
// static constexpr unsigned int DEFAULT_ANCESTOR_SIZE_LIMIT_KVB{101;
static constexpr unsigned int DEFAULT_ANCESTOR_SIZE_LIMIT_KVB{5500};
/** Default for -limitdescendantcount, max number of in-mempool descendants */
// static constexpr unsigned int DEFAULT_DESCENDANT_LIMIT{25};
static constexpr unsigned int DEFAULT_DESCENDANT_LIMIT{36};
/** Default for -limitdescendantsize, maximum kilobytes of in-mempool descendants */
//static constexpr unsigned int DEFAULT_DESCENDANT_SIZE_LIMIT_KVB{101};
static constexpr unsigned int DEFAULT_DESCENDANT_SIZE_LIMIT_KVB{5500};
/**
