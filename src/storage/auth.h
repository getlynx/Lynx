...
bool is_signature_valid_chunk (std::string chunk, int pintOffset, uint160* outSigner = nullptr);
...
bool is_signature_valid_raw(std::vector<unsigned char>& signature, uint256& hash, uint160* outSigner = nullptr);
