...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Lynx Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Lynx Core"
...
#define PACKAGE_BUGREPORT "https://github.com/getlynx/Lynx/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Lynx Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Lynx Core 25.0.32"
...
#define PACKAGE_VERSION "25.0.32"
