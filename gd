...
index 309066eec..393649f0d 100644
--- a/src/storage/rpc.cpp
+++ b/src/storage/rpc.cpp
@@ -55,9 +55,10 @@ static RPCHelpMan putfile()
                 },
...
+//    }
     ...
     std::string put_uuid = "";
@@ -65,6 +66,7 @@ static RPCHelpMan putfile()
...
@@ -293,10 +295,15 @@ static RPCHelpMan addauth()
         type = 0;
...
index 3a12ca5be..2925bdc7d 100644
...
+
     ...
     CScript receiver = it->first->tx->vout[0].scriptPubKey;
     CTxOut txOut(setValue, receiver);
@@ -327,15 +351,23 @@ bool generate_selfsend_transaction(WalletContext& wallet_context, CMutableTransa
...
index ff8f2c3e9..204e352e6 100644
